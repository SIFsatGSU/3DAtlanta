...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'v1.0 Web Player.data';
    var REMOTE_PACKAGE_BASE = 'v1.0 Web Player.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 14883637;
      var PACKAGE_UUID = '44560164-a386-4706-883f-15132ba88b46';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 11553422, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(11553422, 11553594, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(11553594, 11556608, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(11556608, 13359952, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(13359952, 14856012, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(14856012, 14883637, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_v1.0 Web Player.data');

    };
    Module['addRunDependency']('datafile_v1.0 Web Player.data');
